...
The theoretical base is present in \hyperref[methods]{methods}, the overview of implementation and results in \hyperref[implementation]{implementation}, and \ref[conclusion]{conclusion} at the end.
...
\subsection*{Adding Berendsen thermostat}
