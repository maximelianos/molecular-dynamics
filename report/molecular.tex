...
Calibrated step = 0.1 (unit?)
Berendsen relax = 50 000 step t
...
Latent heat is the additional energy to transform from solid to liquid state. During melting the temperature (and kinetic energy) stay the same, but potential energy increases.
...
Plot 4. Heat capacity (at which point??) vs cluster size
